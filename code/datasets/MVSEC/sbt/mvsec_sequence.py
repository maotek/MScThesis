...
class MVSECSequence(Dataset):
    ...
    def _ensure_event_slicer(self) -> None:
        ...
        self._h5_event_files = {"data": event_file}
        self.event_slicer = {"data": EventSlicer(event_file)}
    ...
    def __getitem__(self, index: int) -> Dict[str, torch.Tensor]:
        ...
        """
        self._ensure_event_slicer()  # Ensure HDF5 files are open in current worker
