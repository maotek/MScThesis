...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--save-dir", type=str, default="output/train_unet_dav2_rgb", help="Checkpoint output dir.")
    parser.add_argument("--save-every", type=int, default=1, help="Save checkpoint every N epochs.")
    parser.add_argument(
        "--resume-checkpoint",
        type=str,
        # default=os.path.join("output", "train_unet_dav2_rgb", "epoch_050.pt"),
