#!/bin/bash
#SBATCH --job-name=train_dsec_fully_conv_dav2_batch10_ch3_RC
#SBATCH --output=train_dsec_fully_conv_dav2_batch10_ch3_RC_%j.out
#SBATCH --error=train_dsec_fully_conv_dav2_batch10_ch3_RC_%j.err
