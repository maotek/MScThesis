...
apptainer exec --nv ../../apptainer/image.sif python -m train_unet_dav2 --config configs/mvsec/train/unet_dav2_mvsec.json --save-dir output/train_mvsec_unet_dav2_MVSEC_batch10
